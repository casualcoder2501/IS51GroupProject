...
export class MainFooterComponent implements OnInit {
  ...
  saveConversion() {
    ...
    if (this.mainframe.conversionCountry === 'Pick a Currency') {
      ...
      // this.saveHistoryOverflowToLocalStorage();
      // this.saveHistoryOverflowTwoToLocalStorage();
    }
  }
  ...
  save(index: number, arrays: string) {
    if (arrays === 'base') {
      ...
      this.mainframe.currentCountry = this.mainframe.history[index].countryLeft;
      ...
      this.mainframe.currentCountryEdit = this.mainframe.historyOverflow[index].countryLeft;
      ...
      this.mainframe.currentCountryEdit = this.mainframe.historyOverflowTwo[index].countryLeft;
  ...
  //   const savedLocalHistory = localStorage.setItem('currencies', JSON.stringify(this.mainframe.history));
  //   return savedLocalHistory;
  // }
  // saveHistoryOverflowToLocalStorage() {
  //   console.log('saved historyoverflow');
  //   const savedLocalHistoryOverflow = localStorage.setItem('currencies', JSON.stringify(this.mainframe.history));
  //   return savedLocalHistoryOverflow;
  // }
  // saveHistoryOverflowTwoToLocalStorage() {
  //   console.log('saved historyoverflow');
  //   const savedLocalHistoryOverflowTwo = localStorage.setItem('currencies', JSON.stringify(this.mainframe.history));
  //   return savedLocalHistoryOverflowTwo;
  // }
